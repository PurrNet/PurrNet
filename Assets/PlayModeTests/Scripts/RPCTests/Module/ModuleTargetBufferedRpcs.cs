...
public class ModuleTargetBufferedRpcsModule : NetworkModule
{
...
public class ModuleTargetBufferedRpcs : NetworkIdentity
{
    public static ModuleTargetBufferedRpcs LocalInstance;
    public readonly ModuleTargetBufferedRpcsModule module = new();
