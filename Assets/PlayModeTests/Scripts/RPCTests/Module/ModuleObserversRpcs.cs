...
public class ModuleObserversRpcsModule : NetworkModule
{
...
public class ModuleObserversRpcs : NetworkIdentity
{
    public static ModuleObserversRpcs LocalInstance;
    public readonly ModuleObserversRpcsModule module = new();
