...
public class IdentityObserversBufferedRpcs : NetworkIdentity
{
    public static IdentityObserversBufferedRpcs LocalInstance;
    ...
    public void BroadcastBufferedInt(int payload)
    {
    ...
    [ObserversRpc(bufferLast: true)]
    public void BroadcastBufferedString(string payload)
    {
    ...
    [ObserversRpc(bufferLast: true)]
    public void BroadcastBufferedStruct(TestPayload payload)
    {
    ...
    public void BroadcastBufferedDeltaOff(int payload)
    {
    ...
    public void BroadcastBufferedCompNone(int payload)
    {
    ...
    public void BroadcastBufferedCompFast(int payload)
    {
    ...
    public void BroadcastBufferedCompBalanced(int payload)
    {
    ...
    public void BroadcastBufferedCompBest(int payload)
    {
